  ...
  return (
    <div className="w-full h-screen">
      <div className="relative text-white w-full h-[75%] special-bg flex flex-col items-center">
        <div className="h-full w-full md:w-[640px] lg:w-[768px] xl:w-[1024px] 2xl:w-[1280px] flex flex-col items-center xl:items-start justify-center text-center xl:text-start">
