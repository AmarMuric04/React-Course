...
export default function Recipes({ recipes }) {
  ...
  return (
    <AnimatedList className="w-full flex self-center transition-all gap-[79.2px] mt-16  no-scrollbar flex-wrap justify-between  xl:justify-center lg:w-[768px] xl:w-[1024px] 2xl:w-[1280px] ">
