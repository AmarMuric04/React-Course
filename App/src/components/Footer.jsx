...
export default function Footer() {
  return (
    <footer className="w-full h-[40rem] bg-[#141210]">
      <ul className="w-full flex h-[13rem]">
        <li className="w-1/5 h-full bg-red-400">
          <img
      ...
      <div className="py-16 px-32 flex gap-10">
        <div className="flex flex-col w-1/4">
          ...
          <ul className="flex flex-col text-white use-poppins gap-4">
        ...
        <div className="flex flex-col w-1/4 text-white">
          <h1 className="use-playfair text-lg mb-8">Quick Link</h1>
        ...
        <div className="flex flex-col w-1/4 text-white">
          <h1 className="use-playfair text-lg mb-8">Opening Hours</h1>
          <p className="use-poppins font-bold mb-2">Sunday to Friday</p>
          <p className="use-poppins mb-8">9:30 AM to 12:00PM</p>{" "}
          <p className="use-poppins font-bold mb-2">Saturday</p>
          <p className="use-poppins">12:30PM to 6:00PM</p>
        </div>
        <div className="flex flex-col w-1/4 text-white">
          <h1 className="use-playfair text-lg mb-8">Newsletter Subscribe</h1>
          <p className="use-poppins font-thin text-sm mb-4">
